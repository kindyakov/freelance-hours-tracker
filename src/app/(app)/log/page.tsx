...
import { EarningsPanel } from '@/components/log/EarningsPanel'
...
export default function LogPage() {
	...
	return (
		<Stack gap='lg'>
			...
			<div
				id='day-entry-form'
				className='flex lg:items-start gap-5 max-lg:flex-col'
			>
				<EarningsPanel />
				<DayEntryForm />
			</div>
			...
			<div>
				<Title order={4} mb='sm'>
					{monthLabel} — {records.length}{' '}
					{records.length === 1 ? 'день' : records.length < 5 ? 'дня' : 'дней'}
				</Title>
